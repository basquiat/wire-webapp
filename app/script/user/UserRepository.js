...
z.user.UserRepository = class UserRepository {
  ...
  findUserById(userId) {
    if (!userId) {
      return Promise.reject(new z.user.UserError(z.user.UserError.TYPE.MISSING_PARAMETER));
    }
    ...
    return matchingUserEntity
      ...
      : Promise.reject(new z.user.UserError(z.user.UserError.TYPE.USER_NOT_FOUND));
  }
